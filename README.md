...
```javascript
import map4d from 'https://cdn.jsdelivr.net/gh/stdlib-js/utils-map4d@v0.2.3-deno/mod.js';
```
...
[test-image]: https://github.com/stdlib-js/utils-map4d/actions/workflows/test.yml/badge.svg?branch=v0.2.3
[test-url]: https://github.com/stdlib-js/utils-map4d/actions/workflows/test.yml?query=branch:v0.2.3
