...
/**
* Four-dimensional input array.
*/
type Array4D<T> = ArrayLike<ArrayLike<ArrayLike<ArrayLike<T>>>>;
...
* // returns [ [ [ [ 1, 2, 3 ] ] ], [ [ [ 4, 5, 6 ] ] ] ]
*/
declare function map4d<T = unknown, U = unknown, V = unknown>( arr: Array4D<T>, fcn: Callback<T, U, V>, thisArg?: ThisParameterType<Callback<T, U, V>> ): Array<Array<Array<Array<U>>>>;
